    ...
    <div className="ImageGallery block">
      ...
      <div className="Ratio pt-24 " data-aos="fade-up">
        ...
        <p>
          ...
          culpa optio vitae eos quo!
        </p>
      </div>
      <div className="Ratio block   mt-48  gap-8 pt-28 2xl:columns-4 xl:columns-3 sm:columns-1 lg:columns-2">
        {ImageGallery &&
          ImageGallery.map((PhotoDetels, index) => (
            <div
              key={index}
              className="Imagess mb-8 cursor-pointer"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              <img
                className="block mt-0 rounded-md"
                src={PhotoDetels.filePath}
                alt=""
              />
            </div>
          ))}
